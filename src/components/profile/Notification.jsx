        ...
        <>
            ...
            <div>
                {notifications.map((notification) => (
                    <section key={notification._id} className="m-2 hover:border-blue-700 w-full overflow-hidden shadow-md border-[2px]">
                        <div className="py-1">
                            <div className="flex flex-row">
                                <div className="w-full bg-[#F1F1F180] lg:py-2 px-4 lg:bg-white">
                                    <h2 className="text-[14px] font-semibold pt-1">{notification.title}</h2>
                                    <div className="flex flex-row">
                                        <span className="text-[#7C7C7C] text-[10px] lg:text-[14px] justify-start">
                                            {notification.message}
                                        </span>
                                    </div>
                                    <div className="text-[#7C7C7C] text-[12px] py-1">{formatDate(notification.dateTime)}</div>
                                </div>
                                <div className="px-2">
