					...
					{authenticated ? (
						<>
							<button
								...
								className="block border-4 py-[5px] lg:py-2.5 px-[10px] lg:px-4 bg-gradient-to-b from-[#FAAC06] to-[#EB8105]  text-[14px] md:text-sm lg:w-52 text-black text-center font-semibold font-poppins rounded-md ">
								LOG OUT
							</button>
						</>
					) : (
