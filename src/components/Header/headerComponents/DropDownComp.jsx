...
const DropDownComp = ({ category, setIsDroOpen }) => {
  const [selectedSubCat, setSelectedSubCat] = useState(
    category.children && category.children.length > 0 ? { ...category.children[0] } : {}
  );
  ...
  return (
    <div className="w-full bg-white z-[80] absolute top-0 grid lg:grid-cols-6 grid-cols-2 grid-rows-3 lg:grid-rows-1 gap-4 lg:px-[5rem] md:px-10 px-3 py-5 border rounded shadow-lg">
      <div className="flex flex-col border-r lg:col-span-1">
        ...
        <div className="flex flex-col items-center h-full gap-2 p-2 shadow-md w-fit hover:shadow-lg shrink-0">
          ...
          <div className="flex flex-col self-start">
            ...
            <div className="flex flex-row">
              <div className="mr-2 font-medium">{/* Add dynamic pricing here */}</div>
