...
function EditAddress({ existingAddress, onSave, onCancel }) {
	const initialAddress =
		existingAddress && existingAddress.addressLine ? existingAddress.addressLine : '';
	const initialCity = existingAddress && existingAddress.city ? existingAddress.city : '';
	const initialState =
	...
	const handleSubmit = (e) => {
		...
		axios.put(api, updatedAddress).then((response)=>{
