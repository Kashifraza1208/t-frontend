...
function Share({ share, setShare }) {
	return (
		<div className="bg-black opacity-40 backdrop-blur fixed top-0  left-0 right-0 z-50  p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
